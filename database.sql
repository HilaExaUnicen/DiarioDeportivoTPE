...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2021 a las 19:19:03
...
(83, 'Noticia agregada desde la api', 'api post', 'loremdknalwdawjkndhwiuajkdhbnauwjkidhbwauidjhwaidwad', 1),
(89, 'Modificada desde la api', 'api put', 'llreoernmklsmkadas', 1),
...
(35, 'hundawiduwja', '$2y$10$9x6bmek.nB31A7RGlE5ocuLUzJ6wtXFsauSsWGvJSP4OHZCR430V.', 0);
...
ALTER TABLE `comentarios`
  ...
  ADD KEY `id_noticiafk` (`id_noticiafk`),
...
--
ALTER TABLE `noticias`
  MODIFY `id_noticia` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT de la tabla `secciones`
--
ALTER TABLE `secciones`
  MODIFY `id_seccion` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `comentarios_ibfk_1` FOREIGN KEY (`id_noticiafk`) REFERENCES `noticias` (`id_noticia`) ON UPDATE CASCADE,
  ADD CONSTRAINT `comentarios_ibfk_2` FOREIGN KEY (`id_usuariofk`) REFERENCES `usuarios` (`id_usuario`) ON UPDATE CASCADE;
